...
with app.app_context():
    ...
    # Inicializa ou corrige instância padrão WAHA buscando dinamicamente o IP conectado
    ...
    if not waha_inst:
        ...
        # Se contiver 192.168.1.44 ou URL vazia, resolve para o IP correto conectado
        if '192.168.1.44' in (waha_inst.api_url or '') or not waha_inst.api_url:
            waha_inst.api_url = f'http://{connected_ip}:3000'
            waha_inst.api_key = waha_inst.api_key or 'admin123'
        else:
